...
public class ReplenishOrderCRUDVerify extends ReplenishOrderForm{
    ...
    public String getReplenishOrderNo() {
        return Driver.driver.findElement(By.id(ReplenishOrderConstants.RPORDERNO_ID)).getText();
    }
    ...
    public void submitToSeniorDisable() {
        Assert.assertFalse(Driver.driver.findElement(By.id("idBtnSubmitSenior")).isEnabled());
    }


    //View verify
    public ReplenishOrderCRUDVerify replenishOrderNo(String expected) {
        Assert.assertEquals(Driver.driver.findElement(By.id("rpohead_rporderno")).getAttribute("value").trim(),expected );
        return this;
    }
